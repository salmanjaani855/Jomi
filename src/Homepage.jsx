...
export default function Homepage() {
  return (
        ...
        <div className="relative z-10 flex flex-col items-start gap-[1.5rem] md:gap-[2.5rem] w-full max-w-5xl mt-6 animate-fade-slide">
          ...
          <div className="flex flex-col items-start gap-[1rem] md:gap-[1.5rem] text-[1rem] md:text-[1.125rem]">
            <div className="flex flex-wrap items-start gap-[1rem] md:gap-[1.5rem]">
              ...
              <div className="rounded bg-whitesmoke-200 border border-whitesmoke-100 h-[2.75rem] md:h-[3.125rem] flex items-center justify-center px-[1rem] md:px-[1.25rem]">
                <div className="font-medium text-sm md:text-base">Get Started</div>
              </div>
              </Link>
    ...
    `}
        ...
        {/* Trusted Section */}
        <div className="relative z-10 flex flex-col items-start gap-[1rem] md:gap-[1.5rem] text-[0.875rem] md:text-[1rem] text-[#a1a1aa] w-full max-w-5xl">
      ...
      <div className="w-full max-w-[1600px] mx-auto relative flex flex-wrap items-center gap-3 sm:gap-6 
                ...
                mt-10 mb-6 px-4 sm:px-6 lg:px-8 bg-[#18181b]">
...
<div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="flex gap-6 animate-marquee group-hover:pause">
      {[...Array(2)].map((_, idx) => (
        <React.Fragment key={idx}>
          {/* ==== Card 1 ==== */}
          <div className="w-80 sm:w-96 flex-shrink-0 rounded-lg bg-[#18181b] border border-[#3f3f46] 
            ...
            <a href='https://youtu.be/Ubm9ysAJclY?si=r6rACMMUNlee_yK2' target="_blank" rel="noopener noreferrer" className="w-full h-40 sm:h-48 md:h-56 lg:h-64 relative">
          ...
          <div className="w-80 sm:w-96 flex-shrink-0 rounded-lg bg-[#18181b] border border-[#3f3f46] 
            overflow-hidden flex flex-col p-4 text-left text-xs sm:text-sm md:text-base text-gray-200 font-manrope 
            transform transition duration-300 hover:scale-105 hover:bg-[#1f1f23]">
            <a href='https://youtu.be/xQy3xRb5jKw?si=YfcJTdTo3KBsRUp2' target="_blank" rel="noopener noreferrer" className="w-full h-40 sm:h-48 md:h-56 lg:h-64 relative">
          ...
          <div className="w-80 sm:w-96 flex-shrink-0 rounded-lg bg-[#18181b] border border-[#3f3f46] 
            overflow-hidden flex flex-col p-4 text-left text-xs sm:text-sm md:text-base text-gray-200 font-manrope 
            transform transition duration-300 hover:scale-105 hover:bg-[#1f1f23]">
            <a href='https://youtu.be/GByApALC8sY?si=-ALJH5kPVvqTvayL' target="_blank" rel="noopener noreferrer" className="w-full h-40 sm:h-48 md:h-56 lg:h-64 relative">
  ...
  <Link to='/article'>
    <div className="relative rounded bg-gradient-to-r from-indigo-600 to-sky-400 
      ...
      text-sm sm:text-base text-white font-manrope cursor-pointer hover:opacity-90 transition">
      <span className="font-medium">View Articles</span>
    </div>
  </Link>
...
<div className="flex-1 relative border-gray-200 border-solid border-t-[1px] box-border h-[0.063rem]" />
      ...
      {/* Parent Div */}
      <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-6 px-4 sm:px-6 lg:px-12">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-10">
          ...
          {/* Card 1 */}
          <div className="flex-1 flex flex-col items-start gap-4 bg-[#18181b] rounded-lg shadow-md p-4 sm:p-6">
            <img
          ...
          {/* Card 2 */}
          <div className="flex-1 relative rounded-lg bg-[#27272a] flex flex-col items-center justify-center p-4 sm:p-5 md:p-6 gap-2 text-center font-manrope shadow-md h-40 sm:h-44 md:h-48">
            <b className="text-base sm:text-lg md:text-xl lg:text-1xl leading-relaxed text-[#fafafa]">
            ...
            <img
              src={upcomma}
              alt=""
              className="w-6 h-6 absolute top-6 left-4 sm:top-5 sm:left-6"
            />
            <img
              src={downcomma}
              alt=""
              className="w-6 h-6 absolute bottom-4 right-4 sm:bottom-5 sm:right-6"
            />
          </div>
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 py-10 flex flex-col gap-10">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          {/* Card 1 */}
          <div className="flex-[1.5] h-full flex flex-col items-start text-left font-manrope">
          ...
          {/* Card 2 */}
          <div className="flex-[0.9] h-full rounded-lg bg-[#27272a] flex flex-col items-start justify-between p-4 sm:p-6 md:p-8 gap-4 text-left font-manrope">
            {/* Top Content */}
            <div className="w-full flex flex-col items-start gap-6">
              <div className="flex flex-col items-start gap-3">
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-300 leading-relaxed">
                  Lorem ipsum dolor sit amet consectetur. Sem viverra viverra sit
                  cursus felis.
                </p>
              </div>
            ...
            <Link to='/pricing' className="w-full mt-4 rounded bg-gradient-to-r from-indigo-600 to-sky-400 flex items-center justify-center py-3 cursor-pointer hover:opacity-90 transition">
          ...
          {/* Card 3 */}
          <div className="flex-[0.9] h-full rounded-lg border border-darkslategray flex flex-col items-start justify-between p-6 sm:p-8 gap-6 text-left text-base sm:text-lg text-white font-manrope">
            {/* Title */}
            <div className="flex flex-col items-start gap-10">
              ...
              {/* Content */}
              <div className="relative text-sm sm:text-base leading-relaxed text-[#a1a1aa] max-w-full sm:max-w-md md:max-w-lg">
                <p className="m-0">
            ...
            {/* Button */}
            <Link to='/form' className="w-full rounded border border-darkslategray flex items-center justify-center py-3 px-4 text-sm sm:text-base text-whitesmoke cursor-pointer hover:bg-darkslategray/20 transition">
